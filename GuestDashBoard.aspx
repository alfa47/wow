<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GuestDashBoard.aspx.cs" Inherits="RZATest.GuestDashBoard" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="container">
            ...
            <div class="guest-container">
                <asp:Label ID="lblPoints" runat="server" Text="Your Points: "></asp:Label>
