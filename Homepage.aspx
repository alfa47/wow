<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Homepage.aspx.cs" Inherits="RZATest.Homepage" %>
    ...
    <form id="form1" runat="server">
        <nav class="nav">
            <ul>
                ...
                <li><asp:Button ID="Button2" CssClass="btn" runat="server" Text="Button2" /></li>
                <li><asp:Button ID="Button1" CssClass="btn" runat="server" Text="Button1" /></li>
                <li><asp:Button ID="LoginBtn" CssClass="btn" runat="server" Text="Login" /></li>
                <li><asp:Button ID="RegisterBtn" CssClass="btn" runat="server" Text="Register" /></li>
            </ul>
        </nav>
